...
func usage() {
	...
	b.WriteString(" bootstraps SwornAgent in a repo: writes project configuration and an\n")
	b.WriteString("MCP-pointer AGENTS.md. The canonical Baton protocol remains embedded in the binary.\n")
	...
	b.WriteString("(display current setting). Telemetry stays disabled until explicit 'sworn telemetry on'.\n")
