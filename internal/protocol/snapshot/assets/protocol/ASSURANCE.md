# Protocol Assurance 1.0

Most work follows Protocol's standard path. Risky work can require stronger proof
...
- an Implementer design TL;DR reviewed by a distinct Lead;
...
A universal Protocol requirement is justified only when removing it would break
