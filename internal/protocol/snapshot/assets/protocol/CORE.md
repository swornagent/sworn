...
Protocol protects five simple promises: agree the work, save the important facts,
...
belong to the system using Protocol.
...
them. Protocol keeps the applicable approved plan, stable slice and attempt
...
carry the detail. Protocol does not require duplicate narrative artefacts.
...
A `PASS` binds the applicable plan, Lead decision, exact candidate,
...
A procedural defect is not a Protocol `BLOCKED` outcome when these facts can still
