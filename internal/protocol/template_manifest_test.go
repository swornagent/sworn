...
// sworn.release-manifest/v1 identity, never the legacy protocol.plan/v2 fence
// nor an unapproved protocol.plan/v3, and documents the supported prepared-tree
...
func TestPlannerTemplateNamesOnlySwornSchemaAndPreparedTreeContracts(t *testing.T) {
	...
	for _, forbidden := range []string{"protocol.plan/v2", "protocol-plan-v2", "protocol.plan/v3", "protocol-plan-v3"} {
