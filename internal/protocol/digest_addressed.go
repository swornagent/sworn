...
// byte-for-byte stable. This is in-scope product content under internal/protocol;
...
// product content under internal/protocol, not a docs/ path or a vendored asset.
