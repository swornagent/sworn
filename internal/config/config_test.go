...
func TestResolveImplementerModel_LedgerDefault(t *testing.T) {
	...
	m, err := ResolveImplementerModel("", cfg, "harness", ledgerPath)
	if err != nil {
		t.Fatal(err)
	}
	if m != "openai/gpt-4o" {
...
func TestResolveImplementerModel_LedgerFlagWins(t *testing.T) {
	...
	cfg := DefaultConfig()
	m, err := ResolveImplementerModel("anthropic/claude-sonnet-4-20250514", cfg, "harness", ledgerPath)
	if err != nil {
		t.Fatal(err)
	}
	if m != "anthropic/claude-sonnet-4-20250514" {
...
func TestResolveImplementerModel_LedgerAbsentCorpusFallback(t *testing.T) {
	...
	m, err := ResolveImplementerModel("", cfg, "harness", "/nonexistent/path/verdicts.jsonl")
	if err != nil {
		t.Fatal(err)
	}
	if m != "openai/o3-mini" {
...
func TestResolveImplementerModel_LedgerEmptySliceKind(t *testing.T) {
	...
	m, err := ResolveImplementerModel("", cfg, "", ledgerPath)
	if err != nil {
		t.Fatal(err)
	}
	if m != "openai/o3-mini" {
...
func TestResolveEscalationModels_FlagWins(t *testing.T) {	cfg := DefaultConfig()
