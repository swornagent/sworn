...
const (
	...
	ArchiveSHA256        = "sha256:4757078049d8e9f0ac3db2aee91e65f8df48f31b0cccf26478343ca3d79d5166"
	SupportPackageSHA256 = "sha256:e5927a82f7c8a0daf3aa1196e7aa56231044449bb141cc2d7efd1cc8cca209bd"
	ManifestSHA256       = "sha256:b58b3c2f844c0c0b07195c3ef5af8c1819871f11b51d697e06207ad0d4b2ec9c"
	AssetCount           = 14
	AssetBytes           = int64(50387)

	releaseDocumentSHA256 = "sha256:24b74e0edce34ee5535f3c8383a9402134339c5d9b51e18acf62a779a0d57481"
...
func validatePackage(source fs.FS) (Identity, map[string]struct{}, error) {
	...
	if err != nil || string(versionBody) != PackageVersion+"\n" {
		return Identity{}, nil, errors.New("compiled VERSION does not identify Baton RC3")
	}
...
func validateReleaseIdentity(release releaseFile) error {
	if release.Schema != releaseSchema ||
		...
		release.PublishedAt != "2026-07-25T05:23:03Z" {
	...
	if release.Archive.Name != "baton-1.0.0-rc.3.tar.gz" ||
...
func validateReleaseBindings(source fs.FS, release releaseFile, digests map[string]string) error {
	...
	expectedContracts := []releaseContract{
		{"conformance_manifest", "conformance/manifest.json", "baton.conformance-manifest/v2", "sha256:51e31cc623700f6ddba8e18932b816fc981f350f83c5a6ea1e4693d86cbafa98"},
