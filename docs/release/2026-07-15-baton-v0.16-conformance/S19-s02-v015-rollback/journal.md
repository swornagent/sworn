...
- No local Baton installation or S20 work was performed. Fresh adversarial
  ...
  S19-s02-v015-rollback 2026-07-15-baton-v0.16-conformance` session; this
...
`docs/release/2026-07-15-baton-v0.16-conformance/S19-s02-v015-rollback/proof/check-rollback.sh`
...
Next: `/replan-release 2026-07-15-baton-v0.16-conformance`
...
- The same planner ratification changes the release-wide rendered
  `docs/release/2026-07-15-baton-v0.16-conformance/index.md`, which is outside
...
- Required planner action: run `/replan-release
  2026-07-15-baton-v0.16-conformance` and amend only the contract record and
...
- The authoritative rule is executable and current: the repaired checker must
  ...
  `sworn render 2026-07-15-baton-v0.16-conformance
...
2026-07-15-baton-v0.16-conformance` in a fresh session.
...
Next step: `/implement-slice S20-v015-parity-portable-fixture 2026-07-15-baton-v0.16-conformance` in a fresh session.
