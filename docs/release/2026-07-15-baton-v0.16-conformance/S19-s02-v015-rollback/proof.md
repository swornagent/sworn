...
- `go vet ./...` — PASS (0)
- `git diff --exit-code e61cb190736ee7483fb4ed1a993442b26ce3574c HEAD -- . ':(exclude)docs/release/2026-07-15-baton-v0.16-conformance/**'` — PASS (0)
...
2026-07-15-baton-v0.16-conformance --base
...
```text
$ sworn verify S19-s02-v015-rollback 2026-07-15-baton-v0.16-conformance
{
  "verdict": "BLOCKED",
...
$ git diff --no-ext-diff 640396fa8cc319229d6f96dedfdbef65dbe317fe | \
    sworn verify --spec docs/release/2026-07-15-baton-v0.16-conformance/S19-s02-v015-rollback/spec.json \
      --diff - \
      --proof docs/release/2026-07-15-baton-v0.16-conformance/S19-s02-v015-rollback/proof.json
{
  "verdict": "PASS",
  "rationale": "",
  "cost_usd": 0
...
2026-07-15-baton-v0.16-conformance` session, which must run the checker with
