...
**Slice:** `S19-s02-v015-rollback` · **Track:** `T1-foundation` · **Release:** `2026-07-15-baton-v0.16-conformance`
...
3. **Make equality fail closed.** The committed proof checker will compare the
   ...
   only `docs/release/2026-07-15-baton-v0.16-conformance/**` is the independent
