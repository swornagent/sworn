...
- Planning-authority bootstrap oracle adapter explicitly authorised by the
  ...
  2026-07-15-baton-v0.16-conformance --json`, normalized only its legacy
...
- Re-ran the explicitly authorised pre-cutover oracle as
  `/home/brad/go/bin/sworn board --release
  2026-07-15-baton-v0.16-conformance --json`, confirmed S01 remains `verified`
...
- No source, test, configuration, proof, claim, receipt, report, real-home, or
  ...
  is `/replan-release 2026-07-15-baton-v0.16-conformance`, which must assign the
