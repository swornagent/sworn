...
- The design-review LLM check passed with the current CLI spelling: `sworn llm-check --type design-review --release 2026-07-15-baton-v0.16-conformance --slice S20-v015-parity-portable-fixture`.
