...
- Tracking: `/replan-release 2026-07-15-baton-v0.16-conformance`. The Coach
...
- S20 returns to `blocked` for planner handling. This session does not modify
  ...
  2026-07-15-baton-v0.16-conformance`.
...
- S20 returns to `blocked` and stops. The manual Gate-8 Implementer
  ...
  triage through a fresh `/replan-release 2026-07-15-baton-v0.16-conformance`
