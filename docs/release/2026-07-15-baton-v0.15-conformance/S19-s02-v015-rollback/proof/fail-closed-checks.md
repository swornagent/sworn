...
record has the exact-head Implementer PASS/report binding, a complete proof
bundle, and `state: verified` with a `pass` verdict, fresh-context flag, and
verdict timestamp; otherwise it fails closed as premature.
