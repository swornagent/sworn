...
// development-only Baton RC3 oracle corpus. Ordinary verification never
...
func run(args []string, stdout, stderr io.Writer) int {
	...
	if len(args) == 9 && args[0] == "generate" && args[1] == "--reference-root" &&
		...
		fmt.Fprintln(stdout, "batongolden: generated pinned RC3 corpus from JavaScript oracle")
		return 0
	}
...
func pinnedReferenceSources() []manifestSource {
	return []manifestSource{
		...
		{"git.mjs", "sha256:e66e4bd771651154d2feee6efb35a852047115bffb99846d605958ddd80826f0"},
